...
\maketitle
% Quản lý nhà đầu tư và Admin khác
\thispagestyle{empty}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \hline
        \textbf{Mã tài liệu}         & SRS\_AI\_STOCK\_PREDICT\_V1.0                                                     \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \hline
        \textbf{NLP}                 & Natural Language Processing - Xử lý ngôn ngữ tự nhiên (dùng để phân tích tin tức chứng khoán).      \\
        \hline
...
\begin{enumerate}
    ...
    % Thống nhất từ gọi: Chỉ sử dụng mã cổ phiếu hoặc chứng khoán
    ...
    \item \textbf{Nhà phân tích tài chính}
          \begin{itemize}
              \item Chuyên gia hoặc cá nhân thực hiện phân tích dữ liệu tài chính và chứng khoán
    ...
    \item \textbf{Nhà nghiên cứu và học thuật}
          \begin{itemize}
              ...
              \item Sử dụng hệ thống để nghiên cứu mô hình học máy và dữ liệu chứng khoán
...
%Chia ra theo từng nhóm đối tượng 
% 3.1 Nhà Đầu tư 
% 3.2 Quản trị viên
\subsection{Quản lý Người dùng và Xác thực (User Management \& Authentication)}
\subsubsection{Đăng ký và Quản lý Hồ sơ Nhà đầu tư}
\begin{table}[htbp]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \hline
        %Ghi rõ thông tin yêu cầu 
        \textbf{FR-02} & Hệ thống \textbf{SHALL} hỗ trợ gửi email kích hoạt tài khoản (OTP/Link).                     \\
        \hline
...
\subsubsection{Quản trị viên (Administrator Management)}
\begin{table}[htbp]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{|l|X|}
...
\subsection{Tra cứu Thông tin và Biểu đồ (Stock Data \& Charting)}
\subsubsection{Tìm kiếm và Lọc dữ liệu}
\begin{table}[htbp]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{|l|X|}
...
\subsubsection{Biểu đồ phân tích kỹ thuật}
\begin{table}[htbp]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{|l|X|}
...
\subsection{Hệ thống Dự báo bằng Trí tuệ Nhân tạo (AI-Driven Prediction System)}

\Needspace{12\baselineskip}
\subsubsection{Luồng dự báo và Khuyến nghị}
...
\subsubsection{Quản lý và Đánh giá Mô hình (AI Model Management)}
...
\subsection{Tích hợp Hệ thống Bên ngoài (Integration with External Systems)}
...
\subsection{Hệ thống Thông báo và Báo cáo (Notification \& Reporting)}
...
\begin{enumerate}[label=\arabic*)]
    ...
    \item \textbf{Process Flow Diagrams}
          ...
          \begin{figure}[htbp]
              \centering
              \includegraphics[width=1\textwidth]{images/investor-use-case.png}
          \end{figure}
          % use case lệch
          \newpage
          ...
          \begin{figure}[htbp]
              \centering
              \includegraphics[width=0.8\textwidth]{images/admin-use-case.png}
          \end{figure}
